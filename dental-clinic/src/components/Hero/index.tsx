            ...
            />
                ...
                <div className=" relative z-10 mx-auto max-w-\[800px] text-center">
                    ...
                    <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                        <Link href="/contact-us" className="rounded-4xl px-8 py-4 text-base font-semibold btn bg-primary text-background duration-300 ease-in-out hover:bg-primary/80">{data.ctaPrimary}</Link>
                    </div>
                </div>
            </section>
    );
